...
var GoModels = []Model{
	...
	},
	{
		...
		ContextWindow: 1_000_000,
		MaxTokens:     131_072,
		Pricing:       Pricing{InputPerM: 0.14, OutputPerM: 0.28, CacheReadPerM: 0.0028},
		PingCostUSD:   0.0001,
		Notes:         "Efficient long-context. Permanent ~98% off via Xiaomi partnership. Cache behaviour empirically unverified.",
	},
	{
		...
		ContextWindow: 1_000_000,
		MaxTokens:     131_072,
		Pricing:       Pricing{InputPerM: 0.435, OutputPerM: 0.87, CacheReadPerM: 0.0036},
		PingCostUSD:   0.0001,
		Notes:         "High-capability long-context sibling of MiMo V2.5. Permanent ~99% off via Xiaomi partnership.",
	},
	{
